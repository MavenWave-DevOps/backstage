...
const cicdContent = (
  <EntitySwitch>
    <EntitySwitch.Case if={isCloudbuildAvailable}>
      <CloudbuildRouter />
      <LatestWorkflowRunCard branch='main'/>
      <LatestWorkflowRunCard branch='stage'/>
      <LatestWorkflowRunCard branch='test'/>
      <LatestWorkflowRunCard branch='dev'/>
      <LatestWorkflowRunCard branch='ops'/>
    </EntitySwitch.Case>
